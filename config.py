...
save_dir = "model"
answer_dir = "log"
train_record_file = os.path.join(target_dir, "train.json")
dev_record_file = os.path.join(target_dir, "dev.json")
test_record_file = os.path.join(target_dir, "test.json")
...
flags.DEFINE_boolean("finetune", True, "finetune the model")
...
flags.DEFINE_integer("encoder_block_num", 17, "Number of blocks in the model encoder layer")
flags.DEFINE_integer("model_block_num", 5, "Number of blocks in the model encoder layer")
